<div class="w-full h-full">
    <div class="flex flex-col relative">
        ...
        <div class="w-full h-full flex flex-col items-center justify-center flex-1 py-1 md:py-14">
            @if (session('registerSuccess'))
                <p class="w-[320px] mx-auto bg-green-700 text-green-100 py-2 px-2 rounded-md mb-2">
                    {{ session('registerSuccess') }}
                </p>
            @endif
            <form wire:submit='login'>
                <div class="bg-white px-4 pt-8 pb-12 shadow-md shadow-gray-300 border border-gray-400 rounded-md w-[320px] flex flex-col gap-1">
                    ...
                    <button wire:loading.class='disabled' type="submit" class="disabled:bg-gray-400 disabled:text-gray-100 bg-blue-700 text-white py-2 px-11 mt-3">Login</button>
